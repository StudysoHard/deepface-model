...
from deepface.milvus import milvus as milvus
...
def verify(img1_path, img2_path = '', model_name = 'VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = False, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base'):
	...
	img_list, bulkProcess = functions.initialize_input(img1_path)
	...
	disable_option = (False if len(img_list) > 0 else True) or not prog_bar
	...
	for index in pbar:
		...
		if type(instance) == list:
			...
			for i in  model_names:
				...
				# 将img1 去milvus中搜索  并且插入查询记录
				img2_representation =  milvus.insertAndFindMilvus(img1_representation)
